...
1. **The root is RLHF, in the weights.** Reward models often prefer the agreeable answer to the truthful one, and "matching user beliefs" ranks among the more predictive features of human preference. Exact rates vary widely by dataset and setup — treat specific percentages as illustrative, not settled. (Sharma et al., *Towards Understanding Sycophancy in LMs*, arXiv:2310.13548, ICLR 2024; Shapira et al., *How RLHF Amplifies Sycophancy*, arXiv:2602.01002.)
...
4. **A blinded / separate critic beats same-context self-review.** Reviewing in a fresh context outperforms self-review in the same thread, which can even make things worse; simultaneous (blinded) judging yields a net correction over conversational follow-up. (Cross-context review, arXiv:2603.12123; simultaneous-judge correction, arXiv:2509.16533.)
...
6. **Social sycophancy is the dangerous domain.** On relationship/advice content, models endorse the user far more often than warranted. (ELEPHANT, arXiv:2505.13995; Cheng et al., arXiv:2510.01395 — preprint; note these are related lines of work on social sycophancy, not two independent confirmations.) This is exactly where a relational guardian matters.
